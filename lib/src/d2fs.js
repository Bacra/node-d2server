	...
	function buildDiv(){
		...
		if (pageNum) {
			...
			for(var i = 0; i < pageNum; i++) {
				pages1.push('<a href="'+host1+pages[i].href+'" style="margin-right: 12px; white-space: nowrap;">'+pages[i].title+'</a>');
				pages2.push('<a href="'+host2+pages[i].href+'" style="margin-right: 12px; white-space: nowrap;">'+pages[i].title+'</a>');
			}
		...
		div.innerHTML = '<em style="position: absolute; top: 4px; right: 8px; cursor: pointer; font-size: 16px;">×</em><h2 style="font-weight: bold; font-size: 14px;">Dev Pages:</h2><p>'+pages1+'</p><h2 style="margin-top: 8px; font-weight: bold; font-size: 14px;">View Pages:</h2><p>'+pages2+'</p>';
