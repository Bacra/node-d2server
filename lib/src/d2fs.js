	...
	function buildDiv(){
		...
		if (pageNum) {
			...
			for(var i = 0; i < pageNum; i++) {
				pages1.push('<a href="'+devSitePath+pages[i].href+'" style="margin-right: 12px; white-space: nowrap; float: left;">'+pages[i].title+'</a>');
				pages2.push('<a href="'+viewSitePath+pages[i].href+'" style="margin-right: 12px; white-space: nowrap; float: left;">'+pages[i].title+'</a>');
			}
