...
;(function(div, isVisible, ltIE7){
	...
	function buildDiv(){
		...
		div.innerHTML = fixStyle('<div id="d2_extDiv"><div id="d2_extDiv__closeBt">×</div><div class="d2_extDiv__tag" id="d2_extDiv__devTag">Show Dev Pages</div><div class="d2_extDiv__box" id="d2_extDiv__devBox">'+pages1+'</div>'
			+'<div class="d2_extDiv__clear"></div><div class="d2_extDiv__tag" id="d2_extDiv__viewTag">Show View Pages</div><div class="d2_extDiv__box" id="d2_extDiv__viewBox">'+pages2+'</div>'
			+'<div class="d2_extDiv__clear"></div><div class="d2_extDiv__tag" id="d2_extDiv__spliceTag">Show Splice Pages</div><div class="d2_extDiv__box" id="d2_extDiv__spliceBox">'+pages3+'</div><div class="d2_extDiv__clear"></div>'
