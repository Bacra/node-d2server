...
function getIoScriptTag(dirname){
	return '\n<script type="text/javascript">var module77777222 = window.module; window.module = false;</script>\n'+mimeTag.js(d2fsJS.socketUri)+'\n<script type="text/javascript">window.module = module77777222;</script>\n'+mimeTag.js(d2fsJS.getD2fsUri(dirname));
}
